        ...
        ScrollView(.vertical) {
            VStack(alignment: .leading) {
                ...
                Group{
                    ...
                    UserRatingView(userRating: self.$userRating, canEdit: true, gameId: self.$gameOverview.id, coverUrl: self.coverUrl + gameOverview.coverImageId + ".jpg", gameName: gameOverview.name  ).padding(.leading, 16)
                }
